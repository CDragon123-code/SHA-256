...
check_antennas -report_file /home/openroad/SHA-256/flow/antenna_pre_route.rpt
...
check_antennas -report_file /home/openroad/SHA-256/flow/antenna_post_route.rpt
...
check_antennas -verbose -report_file /home/openroad/SHA-256/flow/SHA256_15ns_antenna_signoff.rpt

# ===== Route DRC signoff report =====
set drc_file /home/openroad/SHA-256/flow/route_drc_15ns.rpt
set fp [open $drc_file r]
set drc_content [read $fp]
close $fp

set signoff_file /home/openroad/SHA-256/flow/SHA256_15ns_route_drc_signoff.rpt
...
puts $fp ""
puts $fp "============================================"
puts $fp "PASS: 0 routing DRC violations"
puts $fp "============================================"
close $fp
